...
""" Run Utterance Masked Language Modeling on (Bert, RoBERTa)."""
...
from src.transformers import UMLMProcessor
from src.transformers import (
    WEIGHTS_NAME,
    AdamW,
    BertConfig,
    BertForUtteranceLanguageModeling,
    BertTokenizer,
    RobertaConfig,
    RobertaForUtteranceLanguageModeling,
    RobertaTokenizer,
    get_linear_schedule_with_warmup,
)
from src.transformers import glue_compute_metrics as compute_metrics
from src.transformers import umlm_convert_example_to_features as convert_examples_to_features
...
MODEL_CLASSES = {
    "bert": (BertConfig, BertForUtteranceLanguageModeling, BertTokenizer),
    "roberta": (RobertaConfig, RobertaForUtteranceLanguageModeling, RobertaTokenizer),
}
